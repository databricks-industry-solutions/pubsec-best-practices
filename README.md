...
| [executor-log-viewer](solution-accelerators/executor-log-viewer/) | Read Spark executor/driver logs from terminated job clusters (delivered by Cluster Log Delivery to a UC Volume) — as a notebook or an on-behalf-of-user Databricks App; air-gap ready |
